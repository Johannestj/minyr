...
func Convert() error {
	...
	if _, err := os.Stat("yr/kjevik-temp-fahr-20220318-20230318.csv"); !os.IsNotExist(err) {
		...
		fmt.Print("Output filen eksisterer fra før av, ønsker du å regenerere den? (j/n): ")
	...
	dataText := "Data er basert paa gyldig data (per 18.03.2023) (CC BY 4.0) fra Meteorologisk institutt (MET); endringen er gjort av Johannes Tjøstheim,,,"
